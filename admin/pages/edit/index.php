        ...
        <div id="tird">
            <section id="composant">
                <details open>
                    ...
                    <div id="left" class="left complist">
                        <div class="item">
                            <div class="iscomp">
                ...
                <details>
                    ...
                    <div class="textcontainer complist">


                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 36px; font-weight: bold;">Hd 1</div>
                        ...
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 32px; font-weight: bold;">Hd 2</div>
                        ...
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 28px; font-weight: bold;">Hd 3</div>
                        ...
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 24px; font-weight: bold;">Hd 4</div>
                        ...
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 14px; ">Paragraphe</div>
                        ...
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div style="font-size: 14px; ">List</div>
                ...
                <details>
                    ...
                    <div class="interativecontainer complist">
                        <div class="item">
                            <div class="iscomp">
                                <div class="compreview">
                                    <div
                                        style="width: 100%; background-color: var(--edit-line); padding: 12px; border-radius: 2px;">
